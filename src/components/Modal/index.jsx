...
export default function Modal({ children, isOpen, setIsOpen, label, to, className }) {
  ...
  return (
    <div className={`${!isOpen && "hidden"} fixed left-0 right-0 top-0 h-[100dvh] z-[99] flex justify-center items-center`}>
      ...
      <div className={`fixed px-[12px] py-[24px] flex-col bg-white rounded-md justify-center items-center max-h-[500px] max-w-[600px] w-[600px] overflow-x-auto ${className}`}>
            {children}
          {label && (
