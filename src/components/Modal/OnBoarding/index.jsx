...
export default function OnBoarding() {
  ...
  useEffect(() => {
    if (step === 1) {
      ...
      const isaccountNumberValid =
        !errorMessage.accountNumber && !!accountNumber;
    ...
    <div className={`${step === 2 ? "block" : "hidden"}`}>
      <InputText
        ...
        onChange={(value) => {
          ...
          setErrorMessage((prev) => ({
            ...prev,
            nik: validationText("NIK", value, 16, 16),
          }));
        }}
        min={16}
        type="numerik"
      ...
      <InputText
        ...
        onChange={(value) => {
          ...
          setErrorMessage((prev) => ({
            ...prev,
            name: validationText("Nama", value, 2),
          }));
        }}
    ...
    <div className={`${step === 3 ? "block" : "hidden"}`}>
      ...
      <InputText
        ...
        onChange={(value) => {
          ...
          setErrorMessage((prev) => ({
            ...prev,
            accountNumber: validationText("No Rekening", value, 8),
          }));
        }}
        type="numerik"
      ...
      <InputText
        ...
        onChange={(value) => {
          ...
          setErrorMessage((prev) => ({
            ...prev,
            address: validationText("Alamat", value, 50),
          }));
        }}
  ...
  return (
    <div className="fixed left-0 right-0 top-0 h-[100dvh] z-[99] flex justify-center items-center">
      ...
      />
      <div
        className="!w-full !h-[100dvh] !bg-black opacity-[0.8]"
          ...
          <div>
            ...
            <div className="mb-[24px]">
              ...
              <button
                className={`${
                  isLoading
                    ? "bg-revampV2-neutral-400 border-evampV2-neutral-400"
                    : "bg-revamp-secondary-500 border-revamp-secondary-500"
                } border py-[8px] px-[46px] text-white text-[14px] font-[600] rounded-[15px]`}
                onClick={stepHandler}
                disabled={!canProceed}>
                {isLoading
                  ? "Loading..."
              ...
              <div className="flex justify-center items-center mt-[80px]">
                <span className="text-revamp-neutral-10 font-[400] text-[14px]">
                  Anda mau ganti akun?{" "}
                  <a
                    href="#"
