      ...
      if (response.status === 200) {
        ...
        if (location.pathname.split("/")[1] === "register") {
          ...
          setModalItem({
            ...
            to: "/forgot/change-password?token=" + response.data.token,
          });
        }
      } else {
    ...
    <div className="h-[100dvh] px-[8px] md:p-[100px] flex justify-center items-center">
      ...
      <div className="w-1/2 md:p-[10px] lg:p-[52px] hidden lg:block">
        <div className="text-start mb-[24px]">
          <a
            href="/login"
            className="text-[14px] font-[500] text-revamp-neutral-9 flex gap-2 items-center">
            <img src={IcBack} className="w-[8px]" alt="Back Icon" /> Kembali ke
            login
          </a>
        </div>
        ...
        <div>
          <div className="text-start mb-[24px]">
            ...
            <span className="text-[16px] font-[400] text-revamp-neutral-7">
              Kode otentikasi telah dikirim ke email Anda.
            </span>
          </div>
          {error && (
          ...
          <div className="mb-[24px]">
            ...
            <div className="flex justify-between items-center mt-[-8px]">
              <span className="text-revamp-neutral-10 font-[500] text-[14px]">
                ...
                {isLoadingOtp ? (
                  <span className="text-revamp-error-300 cursor-pointer">
                    Loading...
                  </span>
                ) : (
                  <a
                    ...
                    className={`${
                      countdown > 0
                        ? "cursor-default text-revamp-neutral-6"
                        : "text-revamp-error-300 hover:underline cursor-pointer"
                    }`}>
                    Kirim Ulang
                  </a>
                )}
              </span>
              <span className="text-revamp-secondary-500">
